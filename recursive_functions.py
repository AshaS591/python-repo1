...
# # wap to print sum of natural numbers from 1 to 100 using recursive functions
# def natural_sum(num): 
#     if num==0:
#         return 0
#     elif num==1:
...
# # wap to display a dictionary where the keys are the characters in a string and its values are its number of occurances
...
# # wap to display a dictionary where the keys are the characters ina string and its values are its ascii values
...
# # wap to check for a number pallindrome using recursive function
...
# # wap to extract all the numeric values in a given items
...
# wap to extract all lowercase characters in a given string using recursive functions
...
#wap to display a dictionary whose keys are words of a sentence  and the values are the length of each word 
