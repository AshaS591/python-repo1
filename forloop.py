...
#11.wap to add all the digits in a user entered number using for loop
...
#12.wap to swap keys and values from a given dictionary using for loop
...
#13.wap to filter to have only single value datatype using for loop
...
#14.wap to display most occuring  words from a given string
...
#15.wap to print all even numbers from 0 to 100 using for loop
for even in range(0,101,2):
    print(even)

#16.wap to print all even numbers from 0 to 100 in a reverse order using for loop
for even in range(100,-1,-2):
    print(even)

#17.wap to print multiplication of a number entered by the user using for loop
num = int(input("Enter a number :"))
for factor in range(1,11):
    print(f"{num} X {factor} = {num*factor}")

#18.wap to print all odd numbers from 1 to 100  using for loop
for odd in range(1,100,2):
    print(odd)

#19.wap to print all even numbers from 0 to 100 in a reverse order using for loop
for odd in range(99,0,-2):
    print(odd)

#20.wap to print factorial of a given number using for loop
num=int(input('Enter a number :'))
fact=1
...
#21.wap to print fibonacci series of a given number using for loop
num=int(input('Enter a number :'))
series=[0,1]
if num==1:
    print(series[0])
...
#22.wap to check for a word pallindrome using for loop
...
#23.wap to check for a number pallindrome using for loop
num=int(input('enter a number :'))
number=str(num)
reverse=''
for digit in number:
...
#  keys are the data type of items of a collection and assign value as a 'mutable data'
...
#25.wap to categorize all file names with respect to its extenction using for loop
...
#26.wap to display a dictionary where the keys are the characters ina string and its values are its ascii values
string=input('Enter a string :')
output={}
for char in string:
...
#27.wap to display a dictionary where the keys are the characters ina string and its values are its number of occurances
string=input('Enter a string :')
output={}
for char in string:
    if char in output:
...
#28.wap to print sum of natural numbers from 1 to 100 using for loop
sum=0
for num in range(1,101):
    sum+=num
print('sum is :',sum)

#29.wap to print sum of even numbers from 0 to 100 using for loop
sum=0
for even in range(0,101,2):
    sum+=even
print('sum is :',sum)

#30.wap to print square of numbers from 1 to 10 using for loop
for square in range(1,21):
    print(f"{square} X {square} = {square**2}")

#31.wap to print sum of cube numbers from 1 to 20 using for loop
sum=0
